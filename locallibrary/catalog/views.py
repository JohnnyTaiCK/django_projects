...
def all_borrowed_books(request):
    ...
    return render(request, 'catalog/bookinstance_list_borrowed_staff.html', context)
...
@login_required
@permission_required('catalog.can_mark_returned', raise_exception=True) #the permission is set in models.py BookInstance
